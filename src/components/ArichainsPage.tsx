        ...
        <main className="flex-1 p-8">
          <div className="text-center mb-12">
            <Image
              ...
              priority
            />
            <h1 className="text-3xl font-bold">Arichains</h1>
            <p className="text-gray-400 text-base md:text-lg max-w-3xl mx-auto mt-2">
              Arichains is a Web3 infrastructure layer that allows modular execution layers to scale and interoperate in a trust-minimized way.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="p-6 rounded-xl border-2 border-[#0070f3]/50 hover:-translate-y-2 hover:shadow-lg hover:border-[#0070f3] transition-transform duration-300 flex flex-col items-start text-left">
              ...
              <p className="text-gray-300 text-sm">
                Monitor the network status and performance metrics of Arichains Network in real-time.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border-2 border-[#0070f3]/50 hover:-translate-y-2 hover:shadow-lg hover:border-[#0070f3] transition-transform duration-300 flex flex-col items-start text-left">
              ...
              <p className="text-gray-300 text-sm">
                Explore blocks, transactions, and validator information for Arichains Network.
              </p>
            </div>
          </div>
        </main>

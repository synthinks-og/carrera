      ...
      <div className="max-w-5xl mx-auto p-6 rounded-3xl">
        ...
        <div className="flex justify-between items-center bg-[#0f172a] p-5 rounded-xl border border-[#0056b3] shadow-lg">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-lg font-semibold text-white">Crossfi - Testnet</h1>
          </div>
          <div className="text-sm text-white">
            <span className="mr-2">Chain ID: crossfi</span>
          ...
          <div className="bg-[#0f172a] p-7 rounded-2xl shadow-lg border border-[#0056b3] max-w-[100%]">
            {!showInstallation ? (
              <div className="flex flex-col items-center text-center">
                ...
                />
                <h2 className="text-2xl font-bold mt-3 text-white">Crossfi Finance</h2>
                <p className="text-gray-300 mt-3 max-w-xl">
                CrossFi Chain is a layer 1 blockchain with a modular architecture. It consists of two integral parts, Cosmos and EVM. Each part is responsible for its specific functionality, with their work completely synchronized as a single organism.                </p>
              </div>
            ) : (
              <Installation />
            )}

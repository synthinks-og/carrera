export const axoneData = {
  name: "Axone",
  chainId: "axone",
  logo: "/logos/axone.jpg",
  description: "Axone is a layer-1 protocol that supports AI collaboration in training, governance, and monetization.",
  installationSteps: [
    {
      language: "bash",

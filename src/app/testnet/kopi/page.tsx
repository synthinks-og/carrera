      ...
      <div className="max-w-5xl mx-auto p-6 rounded-3xl">
        ...
        <div className="flex justify-between items-center bg-[#0f172a] p-5 rounded-xl border border-[#0056b3] shadow-lg">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-lg font-semibold text-white">Kopi - Testnet</h1>
          </div>
          ...
          <div className="bg-[#0f172a] p-7 rounded-2xl shadow-lg border border-[#0056b3] max-w-[100%]">
            {!showInstallation ? (
              <div className="flex flex-col items-center text-center">
                ...
                />
                <h2 className="text-2xl font-bold mt-3 text-white">Kopi</h2>
                <p className="text-gray-300 mt-3 max-w-xl">
                Kopi Money is a decentralized finance (DeFi) protocol combining a Decentralized Exchange (DEX) and a money market.                </p>
              </div>
            ) : (
              <Installation />
            )}

...
<div className="flex justify-between items-center bg-[#0f172a] p-5 rounded-3xl border border-[#0056b3] shadow-lg">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-lg font-semibold">Dill - Testnet</h1>
          </div>
          <div className="text-sm">
            <span className="mr-2">Chain ID: dill</span>
        ...
        <div className="flex flex-col md:flex-row mt-4 gap-4">
          ...
          <div className="bg-[#0f172a] p-7 rounded-3xl flex-1 shadow-lg border border-[#0056b3]">
            <div className="flex flex-col items-center text-center">
              ...
              />
              <h2 className="text-2xl font-bold mt-3">Dill</h2>
              <p className="text-gray-300 mt-3 max-w-xl">
                Dill is a Web3 infrastructure layer that allows modular execution layers to scale and interoperate in a trust-minimized way.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-5 mt-7">
              <div className="bg-[#0f172a] p-5 rounded-2xl border border-[#0056b3] hover:bg-[#005bb5] transition duration-300 text-white shadow-md">
                ...
                <p className="text-gray-300 text-sm mt-1">
                  Monitor the network status and performance metrics of Dill in real-time.
                </p>
              </div>
              <div className="bg-[#0f172a] p-5 rounded-2xl border border-[#0056b3] hover:bg-[#005bb5] transition duration-300 text-white shadow-md">
                <h3 className="font-semibold">Chain Explorer</h3>
                <p className="text-gray-300 text-sm mt-1">
                  Explore blocks, transactions, and validator information for Dill.
                </p>
              </div>
            </div>
          </div>

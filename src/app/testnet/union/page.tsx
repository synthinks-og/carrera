      ...
      <div className="max-w-5xl mx-auto p-6 rounded-3xl">
        ...
        <div className="flex justify-between items-center bg-[#0f172a] p-5 rounded-xl border border-[#0056b3] shadow-lg">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-lg font-semibold text-white">union - Testnet</h1>
          </div>
          <div className="text-sm text-white">
            <span className="mr-2">Chain ID: union</span>
          ...
          <div className="bg-[#0f172a] p-7 rounded-2xl shadow-lg border border-[#0056b3] flex-1 max-w-full overflow-x-hidden">
            {!showInstallation ? (
              <div className="flex flex-col items-center text-center">
                ...
                />
                <h2 className="text-2xl font-bold mt-3 text-white">union</h2>
                <p className="text-gray-300 mt-3 max-w-xl">
                Union network is a hyper-efficient zero-knowledge infrastructure layer for general message passing, asset transfers, NFTs, and DeFi. It's based on consensus verification and has no dependencies on trusted third parties, oracles, multi-signatures, or MPC.                </p>
              </div>
            ) : (
              <Installation />
            )}
